...
public class EntrepriseBean{
	...
	private ArrayList<Entreprise> reentres;
	@EJB
	...
	public ArrayList<Entreprise> getReentres() {
		if(recherche.equals("")){
			reentres=Es.getAll();
			
		}
		else{
			reentres=Es.getbyName(recherche);}
		
		
		return reentres;
	}

	public void setReentres(ArrayList<Entreprise> reentres) {
		this.reentres = reentres;
	}

	public void setEntres(ArrayList<Entreprise> entres) {
		this.entres = entres;
	}
 
 
	public String toRecherche(String var){
		recherche=var;
		String ee="";
		if(var.equals("")){
			reentres=Es.getAll();
			ee="/template/Recherche?faces-redirect=true";
		}
		else{
		reentres=Es.getbyName(var);
		ee="/template/Recherche?faces-redirect=true";
		}
